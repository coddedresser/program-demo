...
export default function ParentingNewsletterPage() {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      alert("Thank you for subscribing! You'll receive our weekly parenting newsletter.")
      setEmail("")
  ...
  const handleReadMore = (articleTitle: string) => {
    alert(`Opening article: "${articleTitle}"\n\nThis feature will be available soon! Subscribe to our newsletter to get notified when new articles are published.`)
  }
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Written by child development experts and experienced parents
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-3">
                ...
                <h3 className="font-semibold mb-2">Weekly Delivery</h3>
                <p className="text-sm text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Join a community of like-minded parents and educators
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-4 border rounded-lg">
                ...
                <p className="text-muted-foreground mb-3">
                  "The newsletter has been a game-changer for our family. The tips are practical and easy to implement."
                </p>
                <p className="text-sm font-medium">- Sarah M., Mother of 2</p>
              </div>
              <div className="p-4 border rounded-lg">
                <div className="flex items-center gap-1 mb-2">
                  {[...Array(5)].map((_, i) => (
                ...
                <p className="text-muted-foreground mb-3">
                  "I love how the articles are backed by research but written in a way that's easy to understand."
                </p>
                <p className="text-sm font-medium">- Michael R., Father of 3</p>
              </div>
            </div>
          </CardContent>
        </Card>
