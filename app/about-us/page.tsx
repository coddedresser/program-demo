  ...
  const team = [
    {
      ...
      role: "Founder & CEO",
      description:
        "Former kindergarten teacher with 10+ years of experience in early childhood education",
    },
    {
      name: "Dr. Michael Chen",
      role: "CTO",
      description:
        "AI researcher specializing in educational technology and child development",
    },
    {
      name: "Emily Rodriguez",
      role: "Head of Design",
      description:
        "Child psychology expert who ensures our content is engaging and developmentally appropriate",
    },
    {
      name: "David Kim",
      role: "Lead Developer",
      description:
        "Full-stack developer passionate about creating accessible educational tools",
    },
  ]
      ...
      <div className="pt-20">
        <div className="container max-w-4xl mx-auto px-5 py-10">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-3xl font-extrabold text-orange-700 mb-3">About Kiwiz</h1>
          ...
          <Card className="mb-8 bg-yellow-50 border border-yellow-200 rounded-2xl shadow-md">
            ...
            <CardContent>
              ...
              <p className="text-gray-700">
                We're committed to supporting parents and educators in fostering creativity, fine motor skills, and a
                love for learning through technology that puts children first.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="mb-8 bg-white border border-orange-200 rounded-2xl shadow-md">
            <CardHeader>
              <CardTitle className="text-orange-700 font-bold">Our Values</CardTitle>
          ...
          <Card className="mb-8 bg-yellow-50 border border-yellow-200 rounded-2xl shadow-md">
            <CardHeader>
              <CardTitle className="text-orange-700 font-semibold">Our Story</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700">
              <p>
                Kiwiz was born from a simple observation: parents and teachers spent hours searching for the right
                content for their children. Existing solutions were too generic, not age-appropriate, or expensive.
              </p>
              <p>
                Our founder, a former kindergarten teacher, saw the need for a tool that could instantly generate
                personalized educational content based on each child’s interests and learning level.
              </p>
              <p>
                Today, Kiwiz serves thousands of families worldwide — helping children develop creativity, fine motor
                skills, and confidence through fun AI-powered activities.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="mb-8 bg-white border border-green-200 rounded-2xl shadow-md">
            <CardHeader>
              <CardTitle className="text-green-700 font-semibold">Meet Our Team</CardTitle>
              <CardDescription>Passionate people behind Kiwiz</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-600 mb-2">
                    Need help with Kiwiz? Our support team is ready to assist.
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-2">We’d love to hear your ideas and suggestions.</p>
                  <Button variant="outline" size="sm" className="border-blue-500 text-blue-600">
                    Send Feedback
                  </Button>
                </div>
          ...
          <Card className="bg-gradient-to-r from-orange-500 to-orange-400 text-white rounded-2xl shadow-md">
            <CardHeader>
              <CardTitle className="font-bold text-white">Kiwiz by the Numbers</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm">Pages Generated</div>
                </div>
                <div>
